...
class DatasetConfig:
    def __init__(
        ...
        self.separate_recovery_rate = separate_recovery_rate
...
class TorchBiochargeDataset(Dataset):
    ...
    def get_stage_recovery_rate_two(self, sleep_stage, sleep_state):
        ...
        mental_multiplier  = {0:0.33, 1:0.111, 2:0.083} # Deep , REM , Light # 0.33, 0.111, 0.083
        physical_multiplier = {0:1, 1:0.5, 2:0.665} # Deep , REM , Light  # 1, 0.5, 0.665

        return [mental_multiplier.get(sleep_stage, 0.083), physical_multiplier.get(sleep_stage, 0.665)]
        # return stage_multiplier.get(sleep_stage, 0.388) # old
